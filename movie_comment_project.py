# -*- coding: utf-8 -*-
"""JAR-trailers-May29-2024.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1y7SeOygZ9H_K5GO1StHhjEhD_yG9gcrn

In this Notebook we aim to:

Based on the 'FinalDataset.csv' file,

*   Based on the 'FinalDataset.csv' file, use linear egression to predict  "Total Comments";
*   get linear regression metrics and coefficients for different models with facial variables

# 1. Setting up - The next two cells are needed if GoogleColab is used OR first time using H2O
"""

# With Google Colab, you are using a publicly available virtual machine, so everytime you connect you need to set up
# and install your packages. For running H20, Java is required.

# To install Java
# ! apt-get install default-jre //ALI REMOVED
# !java -version                //ALI REMOVED

# pip install optuna            //ALI REMOVED
# pip install pandas            //ALI REMOVED
# pip install pygam             //ALI REMOVED
# pip install numpy             //ALI REMOVED
# pip install scikit-learn      //ALI REMOVED
# python -m pip install -U matplotlib //ALI REMOVED
...
# from google.colab import files    // ALI REMOVED
# uploaded = files.upload()         // ALI REMOVED
